    ...
    .pipe(
      htmlValidator.analyzer({
        ignoreMessages: new RegExp(
          "^Section lacks heading. Consider using “h2”-“h6”|^Element “img” is missing required attribute “src”.|Element “source” is missing required attribute “srcset|Consider avoiding viewport values that prevent users from resizing documents."
        ),
      })
    )
    .pipe(
