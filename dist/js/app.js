    ...
    (() => {
            ...
            if (document.querySelector(".icon-menu")) {
                document.addEventListener("click", (function(e) {
                    if (bodyLockStatus && e.target.closest(".icon-menu")) {
                        ...
                        document.documentElement.classList.remove("menu-search");
                    }
                }));
                if (window.innerWidth < 992) document.addEventListener("click", (function(e) {
                    if (bodyLockStatus && e.target.closest(".icon-menu")) if (document.documentElement.classList.contains("menu-open")) {
        ...
        let formValidate = {
            ...
            validateInput(formRequiredItem) {
                let error = 0;
                if (formRequiredItem.dataset.email === "email") {
                    formRequiredItem.value = formRequiredItem.value.replace(" ", "");
                    if (this.emailTest(formRequiredItem)) if (formRequiredItem.value.trim() === "") ; else this.addErrorTwo(formRequiredItem); else this.removeErrorTwo(formRequiredItem);
                } else if (formRequiredItem.dataset.required === "email") {
                    formRequiredItem.value = formRequiredItem.value.replace(" ", "");
                    if (this.emailTest(formRequiredItem)) if (formRequiredItem.value.trim() === "") {
                        ...
                        this.removeErrorTwo(formRequiredItem);
                    }
                } else if (formRequiredItem.dataset.required === "tel") if (!this.phoneTest(formRequiredItem)) if (formRequiredItem.value.trim() === "") {
                    this.addError(formRequiredItem);
                    error++;
                } else {
                    this.addErrorTwo(formRequiredItem);
                ...
                if (formRequiredItem.tagName === "TEXTAREA") if (formRequiredItem.value.length > 1e3) {
                    if (!formRequiredItem.classList.contains("_form-error")) {
                        this.addErrorTextarea(formRequiredItem, "Допустим текст не более 1000 символов");
                        error++;
                    }
            ...
            addErrorTwo(formRequiredItem) {
                formRequiredItem.classList.add("_form-error");
                formRequiredItem.parentElement.classList.add("_form-error");
                let inputError = formRequiredItem.parentElement.querySelector(".form__error");
                if (inputError) formRequiredItem.parentElement.removeChild(inputError);
                if (formRequiredItem.dataset.error) formRequiredItem.parentElement.insertAdjacentHTML("beforeend", `<div class="form__error">${formRequiredItem.dataset.errortwo}</div>`);
            },
            ...
            removeErrorTwo(formRequiredItem) {
                formRequiredItem.classList.remove("_form-error");
                formRequiredItem.parentElement.classList.remove("_form-error");
                if (formRequiredItem.parentElement.querySelector(".form__error")) formRequiredItem.parentElement.removeChild(formRequiredItem.parentElement.querySelector(".form__error"));
            },
        ...
        const initMask = () => {
            ...
            if (telInputs) telInputs.forEach((input => {
            ...
            function formSent(form, responseResult = ``) {
                ...
                setTimeout((() => {
                    if (flsModules.popup) {
                        ...
                        const activeModal = document.querySelector(".popup_show");
                        if (activeModal) flsModules.popup.close(activeModal, 200);
        ...
        class Popup {
            ...
            async _openToHash() {
                ...
                if (button) await this.getModal(button.href, button.getAttribute(this.options.attributeOpenButton), button).then((() => {
        ...
        function initSliders() {
            if (document.querySelector(".swiper")) {
                new swiper_core_Swiper(".js-slider-main", {
                    ...
                    on: {
                        slideChange: function() {
                            const bullets = document.querySelectorAll(".main__pagination .swiper-pagination-bullet");
                            bullets.forEach(((bullet, index) => {
                                if (index === Math.min(this.realIndex, 4)) bullet.classList.add("swiper-pagination-bullet-active-main"); else bullet.classList.remove("swiper-pagination-bullet-active-main");
                            }));
                        }
                    }
                });
                new swiper_core_Swiper(".js-slider-news", {
                    modules: [ Navigation, Pagination ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                    ...
                    on: {
                        slideChange: function() {
                            const bullets = document.querySelectorAll(".news__pagination .swiper-pagination-bullet");
                            bullets.forEach(((bullet, index) => {
                                if (index === Math.min(this.realIndex, 4)) bullet.classList.add("swiper-pagination-bullet-active-main"); else bullet.classList.remove("swiper-pagination-bullet-active-main");
                            }));
                        }
                ...
                new swiper_core_Swiper(".js-slider-review", {
                    modules: [ Navigation, Pagination ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                    ...
                    on: {
                        slideChange: function() {
                            const bullets = document.querySelectorAll(".review__pagination .swiper-pagination-bullet");
                            bullets.forEach(((bullet, index) => {
                                if (index === Math.min(this.realIndex, 4)) bullet.classList.add("swiper-pagination-bullet-active-main"); else bullet.classList.remove("swiper-pagination-bullet-active-main");
                            }));
                        }
                ...
                new swiper_core_Swiper(".js-slider-thumbs", {
                    modules: [ Thumb ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 3,
                ...
                new swiper_core_Swiper(".js-slider-action", {
                    modules: [ Thumb ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
                ...
                new swiper_core_Swiper(".js-slider-gallery", {
                    modules: [ Navigation, Pagination ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
            ...
            scrollWatcherConstructor(items) {
                if (items.length) {
                    ...
                    let uniqParams = uniqArray(Array.from(items).map((function(item) {
                        return `${item.dataset.watchRoot ? item.dataset.watchRoot : null}|${item.dataset.watchMargin ? item.dataset.watchMargin : "-150px"}|${item.dataset.watchThreshold ? item.dataset.watchThreshold : 0}`;
                    })));
                    uniqParams.forEach((uniqParam => {
                        ...
                        let groupItems = Array.from(items).filter((function(item) {
                            ...
                            let watchMargin = item.dataset.watchMargin ? item.dataset.watchMargin : "-150px";
        ...
        if (catalogItems01) if (window.innerWidth > 1420) catalogItems01.forEach((item => {
        ...
        if (catalogItems.length > 0) {
            if (window.innerWidth > 1420) catalogItems.forEach((item => {
                item.addEventListener("mouseover", (() => {
                    item.classList.add("_active");
                    const nextElement = item.nextElementSibling;
                    if (nextElement) {
                        nextElement.style.transition = "height 0.3s ease-in-out, opacity 0.3s ease-in-out";
        ...
        if (animateItems[0]) animateItems.forEach((element => {
            ...
            if (items[0]) items.forEach(((element, index) => {
                if (window.matchMedia("(max-width: 1800px)").matches) element.style.animationDelay = "0.1s"; else {
                    const delayInSeconds = index % 6 * .1 + .1;
        ...
        if (actionBottomLink) {
            ...
            document.addEventListener("click", (event => {
                if (!actionBottomItems.contains(event.target)) actionBottomItems.classList.remove("_active");
            }));
        }
        document.addEventListener("DOMContentLoaded", (function() {
            const jsSortTitle = document.querySelector(".js-sort-title");
            const constructorSortItems = document.querySelector(".constructor-sort__items");
            if (jsSortTitle) {
                ...
                constructorSortItems.addEventListener("click", (function(event) {
                    if (event.target.classList.contains("js-sort-item")) {
                        ...
                        if (nextElement) {
                            nextElement.classList.toggle("_active");
                            if (nextElement.classList.contains("_active")) nextElement.style.maxHeight = nextElement.scrollHeight + "px"; else nextElement.style.maxHeight = "0";
                        }
                    }
                }));
            }
        ...
        const callbackMap = function(entries, observer) {
            entries.forEach((entry => {
                if (entry.isIntersecting) {
                    ...
                    script.src = "https://api-maps.yandex.ru/2.1/?apikey=f62fedc8-83b7-4f5c-8c7b-a771b0530843&lang=ru_RU";
                    script.async = true;
                        ...
                        function init() {
                            ymaps.ready((function() {
                                var myMap = new ymaps.Map("map", {
                                    center: window.innerWidth < 655 ? [ 55.779324, 37.581623 ] : window.innerWidth < 991 ? [ 55.779324, 37.583623 ] : window.innerWidth < 1200 ? [ 55.775324, 37.587623 ] : [ 55.775324, 37.583623 ],
                                    zoom: 15
                                }), myPlacemark1 = new ymaps.Placemark([ 55.78249, 37.580481 ], {
        ...
        window.addEventListener("scroll", (() => {
            if (window.innerWidth > 992) {
                ...
                if (menu && window.scrollY > 0) menu.classList.remove("menu-open");
                if (search && window.scrollY > 0) search.classList.remove("menu-search");
            }
        }));
        const actionInfoImg = document.querySelectorAll(".js-photo");
        if (actionInfoImg) if (window.innerWidth > 992) {
            function updateFlex() {
        ...
        const initInputFiles = () => {
            ...
            loaders.forEach((loader => {
                ...
                const checkErrors = () => {
                    if (errorsArr[0]) createError(); else {
        ...
        document.addEventListener("DOMContentLoaded", (() => {
            ...
            document.addEventListener("click", (function(event) {
                if (!event.target.closest(".header__column")) headerColumns.forEach((column => {
                    column.classList.remove("_active");
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            if (iconMenu && window.innerWidth >= 1024) {
                iconMenu.click();
